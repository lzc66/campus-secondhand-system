    ...
    <header class="public-header">
      <div class="page-shell nav-inner">
        ...
        <nav>
          ...
          <RouterLink to="/items">商品</RouterLink>
          <RouterLink to="/wanted-posts">求购</RouterLink>
          <RouterLink to="/announcements">公告</RouterLink>
          <RouterLink to="/register">注册</RouterLink>
        </nav>
        <div class="actions">
          <RouterLink class="ghost-link" to="/login">学生登录</RouterLink>
          <RouterLink class="solid-link" to="/admin/login">管理入口</RouterLink>
        </div>
      </div>
    </header>
    <main>
...
.solid-link { background: var(--brand); color: #fff; border-color: transparent; }
