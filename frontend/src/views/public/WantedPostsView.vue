<template>
  <div class="page-shell page-block">
    <SectionHeading
      title="求购广场"
      description="看看同学们正在寻找哪些物品，也可以登录后发布求购。"
      tag="Wanted Market"
      ><RouterLink to="/user/wanted-posts">我的求购</RouterLink></SectionHeading
    >
      ...
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item label="排序"
          ><el-select v-model="filters.sortBy" style="width: 140px"
            ><el-option label="最新发布" value="latest" /><el-option label="最热浏览" value="popular" /></el-select
        ></el-form-item>
...
async function fetchPosts() {
  const data = await publicApi.getWantedPosts({ page: 1, size: 12, ...filters });
