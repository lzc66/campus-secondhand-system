...
CREATE TABLE notifications (
    ...
    retry_count TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Email delivery retry count',
...
CREATE TABLE admin_operation_logs (
    ...
    target_type ENUM('registration', 'user', 'item', 'comment', 'wanted_post', 'announcement', 'order', 'system_setting') NOT NULL COMMENT 'Managed object type',
    target_id BIGINT UNSIGNED NOT NULL COMMENT 'Managed object id',
    operation_type ENUM('approve', 'reject', 'disable', 'enable', 'edit', 'delete', 'restore', 'publish', 'offline', 'other', 'create', 'update', 'update_status', 'cancel', 'close') NOT NULL COMMENT 'Operation type',
